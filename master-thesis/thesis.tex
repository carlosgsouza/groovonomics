...
\ppgccufmg{
  ...
  authorrev={Souza, Carlos Alexandre Garcia de},
  cutter={DS729e},
  cdu={519.6*33(043)},
  university={Universidade Federal de Minas Gerais - Departamento de Ci\^{e}ncia da Computa\c{c}\~{a}o},
  ...
  keywords={Computa\c{c}\~{a}o - Teses, Linguages de programa\c{c}\~{a}o - Teses, Groovy (Linguagem de programa\c{c}\~{a}o de computador) - Teses},
}
...
Conversely, dynamically typed languages also have advantages (\cite{types_and_programming_languages, dynamically_typed_languages}):
\begin{itemize}
...
As found in the recent work of Hanenberg et al.(\cite{Hanenberg13}), dynamically typed code potentially has a positive impact on the development time of easier tasks.
